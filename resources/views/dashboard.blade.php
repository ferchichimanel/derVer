            ...
            <div class="modal fade" id="modal-chord" tabindex="-1" role="dialog" aria-labelledby="modal-chordTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            chord diagram à pour but d'identifier les nouveaux facteurs de diabète et la liaison entre les paramétres endogènes et exogènes collecter
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        </div>
            ...
            <div border="1"  id="legende" class="form-group" style="margin-left: 100px;">
                <TABLE border="0" >
                    <TR>
                        ...
                        <TD class=" col-lg-3 text-center"><FONT COLOR="#6D7373">Température</FONT></TD>
                        <TD  class="col-lg-1 " bgcolor=#08088A></TD>
                        <TD  class="col-lg-1 text-center"><FONT COLOR="#6D7373">Taux de Glycémie</FONT></TD>
                        <TD  class="col-lg-1" bgcolor=#22D83A></TD>
                        <TD class="col-lg-1 text-center" ><FONT COLOR="#6D7373">Position</FONT></TD>
            ...
            <div class="modal fade" id="modal-voronoi" tabindex="-1" role="dialog" aria-labelledby="modal-voronoiTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            le diagramme de Voronoi joue un role important pour visualiser la démographie des populations diabétiques par rapport au 24 gouvernorats de la tunisie dont les points en rouge mis dans chaque zone correspont à l'ensemble des points plus proche du point noire 
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        </div>
...
@push('js')
    ...
    <script>
        ...
        .then(response => {
            ...
            .attr('opacity', 0.90)//opacité label
